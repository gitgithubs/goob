...
apt update
apt upgrade -y
apt install -y mc git wget apache2 php php-mcrypt php-curl p7zip-full tmux secure-delete libapache2-mod-php php-mysql php-curl php-json php-sqlite3 php-xml curl git

sed -i 's/short_open_tag = Off/short_open_tag = On/g' /etc/php/*/*/php.ini
wget https://github.com/gitgithubs/goob/raw/master/main.7z
...
if [ -f $ARCHIVEPASS ]; then
  ...
  srm -vf main.7z; echo "remove archive OK"
  echo " OK"
